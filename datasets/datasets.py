...
import math
import torch
# from torchvision.transform import RandAugment
...
class SurgVisDom(data.Dataset):
    ...
    def _sample_indices(self, record):  # 随机产生segments_idx list
        ...
        for i in range(self.num_segments):
            ...
            tick = ticks[i]
            if tick_len >= self.seg_length:  # seg_length=1
...
if __name__ == "__main__":
    train_list = 'D:/SIAT/SurgVisDom/ActionCLIP/lists/k4001/train_frames_new.txt'
    label_list = 'D:/SIAT/SurgVisDom/ActionCLIP/lists/k4001/val_frames_re.txt'
    num_segments = 8
