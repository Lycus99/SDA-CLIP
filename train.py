...
def main():
    ...
    train_data = Action_DATASETS(config.data.train_list, config.data.label_list,  # Todo train_list
    ...
    val_data = Action_DATASETS(config.data.val_list, config.data.label_list,
